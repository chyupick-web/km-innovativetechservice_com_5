...
"resource": {
  ...
  "tags":[{
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\" data-gtmsrc=\"\/\/ak.sail-horizon.com\/horizon\/v1.js\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003Evar s_tag=\"\";\n",["escape",["macro",16],8,16],".includes(\".subject\")?s_tag=\"subject-\"+",["escape",["macro",17],8,16],":",["escape",["macro",16],8,16],".includes(\".school\")?s_tag=\"school-\"+",["escape",["macro",17],8,16],":",["escape",["macro",16],8,16],".includes(\".language\")?s_tag=\"language-\"+",["escape",["macro",17],8,16],":",["escape",["macro",16],8,16],".includes(\".level\")?s_tag=\"level-\"+",["escape",["macro",17],8,16],":",["escape",["macro",16],8,16],".includes(\".types\")?s_tag=\"highschool\"==",["escape",["macro",17],8,16],"?\"page-high-school\":\"verified\"==",["escape",["macro",17],8,16],"?\"page-verified-certificate\":\"profed\"==",["escape",["macro",17],8,16],"?\n\"page-professional-education\":\"page-\"+",["escape",["macro",17],8,16],":",["escape",["macro",16],8,16],".includes(\".availability\")\u0026\u0026(s_tag=\"type-\"+",["escape",["macro",17],8,16],");s_tag\u0026\u0026(s_tag=s_tag.replace(\" \\x26 \",\"-\").replace(\" \",\"-\").toLowerCase(),Sailthru.setup({domain:\"horizon.edx.org\",spider:!0,tag:s_tag,useStoredTags:!1}));\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":30
  ...
  "rules":[
    [["if",0,1,2],["add",2,5,25,29,37]],
    [["if",4,5],["unless",3],["add",3,11,27,36,39,43]],
    [["if",7],["unless",6],["add",4,34,40]],
    [["if",8,11],["unless",9,10],["add",6]],
    [["if",11],["add",7,15,30,35,16,19,20,21]],
    [["if",11,12],["unless",13],["add",8]],
    [["if",11,14],["add",8]],
    [["if",11,15],["add",8]],
    [["if",1,11],["add",8]],
    [["if",11,16],["add",8]],
    ...
    [["if",2,25,26],["add",13]],
    [["if",27],["add",14]],
    [["if",8,11],["unless",28],["add",0]],
    [["if",11,29],["add",0,41]],
    [["if",11,30],["add",0]],
    [["if",11,31],["add",0]],
    [["if",11,32],["add",0]],
    [["if",11,33],["unless",34,35,36,37],["add",0]],
    [["if",11,38],["add",0]],
    [["if",11,39],["add",17,18]],
    [["if",40],["add",22]],
    [["if",7],["add",23]],
    ...
    [["if",44],["add",28]],
    [["if",41,45],["add",31]],
    [["if",8,41],["unless",46,47],["add",31]],
    [["if",41,48],["add",31]],
    [["if",41,46],["unless",45],["add",32]],
    [["if",43,50],["add",32]],
    [["if",51,52],["add",33]],
    [["if",41,49],["add",38],["block",31]],
    [["if",11,53],["add",41]],
    [["if",41,54],["add",42]],
    [["if",55,56,57],["add",44]],
    [["if",58,59],["add",45]]]
},
"runtime":[[50,"__hjtc",[46,"a"],[52,"b",["require","createArgumentsQueue"]],[52,"c",["require","encodeUriComponent"]],[52,"d",["require","injectScript"]],[52,"e",["require","makeString"]],[52,"f",["require","setInWindow"]],["b","hj","hj.q"],[52,"g",[17,[15,"a"],"hotjar_site_id"]],["f","_hjSettings",[8,"hjid",[15,"g"],"hjsv",7,"scriptSource","gtm"]],["d",[0,[0,"https://static.hotjar.com/c/hotjar-",["c",["e",[15,"g"]]]],".js?sv\u003d7"],[17,[15,"a"],"gtmOnSuccess"],[17,[15,"a"],"gtmOnFailure"]]],[50,"__awj",[46,"a"],[52,"b",["require","injectScript"]],["b",[0,[0,"https://www.dwin1.com/",[17,[15,"a"],"merchantId"]],".js"],[17,[15,"a"],"gtmOnSuccess"],[17,[15,"a"],"gtmOnFailure"],"awj"]]]
,"permissions":{"__hjtc":{"access_globals":{"keys":[{"key":"hj","read":true,"write":true,"execute":false},{"key":"hj.q","read":true,"write":true,"execute":false},{"key":"_hjSettings","read":true,"write":true,"execute":false}]},"inject_script":{"urls":["https:\/\/static.hotjar.com\/c\/hotjar-*"]}},"__awj":{"inject_script":{"urls":["https:\/\/www.dwin1.com\/*"]}}}

,"security_groups":{
"nonGoogleScripts":["__hjtc","__awj"]}
...
var Ig=[J.C,J.K],Jg=function(a){var b=a[J.bd];b&&Bf(40);var c=a[J.se];c&&Bf(41);for(var d=Sa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==J.bd&&f!==J.se)if(-1<Ta(Ig,f)){var g=f,h=a[f],l=d[e];qg().set(g,h,l,"UA","UA-30",c)}else{}},Kg=function(a,
...
x,v);else{var D=u.vtp_attribute,I=a(t,"element");E=I&&hg(I,D)||v||""}return E;case "MD":var P=u.vtp_mdValue,Q=b(t,"MD",Qr);return P&&Q?Tr(Q,P)||v:Q||v;case "FORM":return f(String(u.vtp_component||"SUBMIT_TEXT"),t,v);default:var T=c(t,x,v);is(T,"aev",u.vtp_gtmEventId);return T}})}();
Y.h.awc=["nonGoogleScripts"],function(){var a=!1;(function(b){Y.__awc=b;Y.__awc.i="awc";Y.__awc.m=!0;Y.__awc.priorityOverride=0})(function(b){if(a)b.vtp_gtmOnSuccess();else{var c=b.vtp_channel||"na",d,e,f;if(b.vtp_group&&0<=b.vtp_group.indexOf(":")){d=b.vtp_group;for(var g=b.vtp_group.split("|"),h=[],l=f=0;l<g.length;l++)if(g[l]){var m=g[l].split(":");if(2==m.length&&m[0]&&m[1]){var p=parseFloat(m[1]);isNaN(p)||(h.push(W(m[0])+
":"+p),f+=p)}}e=h.join("|")}else f=b.vtp_orderValue||0,d=(b.vtp_group||"DEFAULT")+":"+f,e=W(b.vtp_group||"DEFAULT")+":"+W(f);var q=b.vtp_testMode?"1":"0";try{var r=["merchant="+W(b.vtp_merchantId),"ref="+W(b.vtp_orderRef),"amount="+W(f),"parts="+e,"ch="+W(c),"testmode="+q];b.vtp_currency&&r.push("cr="+W(b.vtp_currency));b.vtp_discountCode&&r.push("vc="+W(b.vtp_discountCode));Ns("https://www.awin1.com/sread.img?tt=ns&tv=2&"+r.join("&"))}catch(t){}try{var u={};u.orderRef=b.vtp_orderRef;u.amount=f;b.vtp_currency&&
(u.currency=b.vtp_currency);u.parts=d;b.vtp_discountCode&&(u.voucher=b.vtp_discountCode);u.channel=c;u.test=q;n.AWIN={Tracking:{Sale:u}};O("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure);a=!0}catch(t){M(b.vtp_gtmOnFailure)}}})}();
